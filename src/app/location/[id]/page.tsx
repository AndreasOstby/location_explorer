  ...
  return (
    <div className="flex justify-center">
      <main className=" w-full max-w-[1200px] px-6">
                ...
                <div className="flex p-4 flex-wrap gap-x-20 h-full">
                  <RecommendationItem text="Public transport accessible" icon={
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M4.03652 17.7761H14.9635C15.6107 17.7761 15.99 17.0476 15.6189 16.5174L10.1554 8.71239C9.8369 8.25741 9.16309 8.25742 8.84461 8.71239L3.38114 16.5174C3.00998 17.0476 3.38931 17.7761 4.03652 17.7761Z" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
                      <path d="M10.5 17.7761H19.0566C19.685 17.7761 20.068 17.085 19.735 16.5521L16.1784 10.8616C15.8651 10.3602 15.1349 10.3602 14.8216 10.8616L13.3616 13.1976" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
                    </svg>
                  } />
                  <RecommendationItem text="Public transport accessible" icon={
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex flex-row justify-between gap-4 pt-6">
          <div className="flex flex-2 flex-col w-full mr-20 gap-6 h-full items-center">
            <Dot />
            <div className="w-full px-10 flex justify-center">
              <span className="text-sm">{location.description!}</span>
            </div>
          </div>
          <div className="card flex flex-col shrink-0 w-4/12 bg-slate-400 gap-2">
            <span className="text-lg font-semibold text-secondaryBlack">Tags</span>
            <Line />
...
function Line() {
  return (<div className="w-full h-[2px] bg-lightGray"></div>)
}
function Dot() {
  return (<div className="w-[3px] h-[3px] rounded-full bg-lightGray"></div>)
}
    ...
    <div className="flex gap-6 items-center">
      ...
      <div className="flex items-baseline gap-1 justify-baseline">
        ...
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M7.60777 5.47077C8.19773 4.00002 8.4927 3.26465 8.99995 3.26465C9.50719 3.26465 9.80217 4.00002 10.3921 5.47077L10.4196 5.53926C10.7529 6.37016 10.9195 6.78561 11.2592 7.03813C11.5988 7.29064 12.0447 7.33057 12.9363 7.41043L13.0975 7.42487C14.5569 7.55556 15.2866 7.62091 15.4427 8.08515C15.5989 8.54939 15.057 9.0424 13.9732 10.0284L13.6115 10.3575C13.0628 10.8566 12.7885 11.1062 12.6607 11.4333C12.6368 11.4943 12.617 11.5568 12.6013 11.6204C12.5173 11.9614 12.5976 12.3235 12.7583 13.0476L12.8083 13.273C13.1035 14.6037 13.2511 15.2691 12.9934 15.5561C12.8971 15.6633 12.7719 15.7406 12.6328 15.7785C12.2607 15.88 11.7323 15.4495 10.6756 14.5884C9.98172 14.023 9.63478 13.7403 9.23646 13.6767C9.07978 13.6517 8.92012 13.6517 8.76344 13.6767C8.36511 13.7403 8.01817 14.023 7.32429 14.5884C6.26758 15.4495 5.73922 15.88 5.36707 15.7785C5.22801 15.7406 5.10283 15.6633 5.00651 15.5561C4.74875 15.2691 4.89638 14.6037 5.19163 13.273L5.24164 13.0476C5.4023 12.3235 5.48262 11.9614 5.39858 11.6204C5.38291 11.5568 5.36308 11.4943 5.33923 11.4333C5.21137 11.1062 4.93706 10.8566 4.38843 10.3575L4.02672 10.0284C2.94293 9.0424 2.40104 8.54939 2.55718 8.08515C2.71331 7.62091 3.44299 7.55556 4.90235 7.42487L5.06355 7.41043C5.95524 7.33057 6.40109 7.29064 6.74072 7.03813C7.08036 6.78561 7.24701 6.37016 7.5803 5.53926L7.60777 5.47077Z" fill="black" stroke="black" stroke-width="2" />
        </svg>
      </div>
      <Tag text="Summer" icon={(
        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="8.49996" cy="8.50008" r="1.83333" stroke="#33363F" stroke-width="2" />
          <path d="M8.5 3.54167V2.125" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
          <path d="M8.5 14.8749V13.4583" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
          <path d="M12.0061 4.99392L13.0078 3.99219" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
          <path d="M3.99216 13.0078L4.9939 12.0061" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
          <path d="M13.4583 8.5L14.875 8.5" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
          <path d="M2.12496 8.5L3.54163 8.5" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
          <path d="M12.0061 12.0061L13.0078 13.0078" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
          <path d="M3.99216 3.99216L4.9939 4.9939" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
        </svg>
...
async function ImageShowcase() {
  ...
  return (
    <div className="flex flex-row h-[50vh] gap-2">
      <Image src={"/images/mountains-862870_1920.jpg"} alt="" width={1920} height={1080} className="h-full w-1/2 object-cover"></Image>
      <div className="flex flex-row items-center justify-center gap-2 h-full w-1/2">
        <div className="flex flex-col h-full flex-1 gap-2">
          <Image src={"/images/mountains-1048995_1920.jpg"} alt="" width={1920} height={1080} className="h-[calc(50%-0.25rem)] object-cover"></Image>
          <Image src={"/images/mountains-1048995_1920.jpg"} alt="" width={1920} height={1080} className="h-[calc(50%-0.25rem)] object-cover"></Image>
        </div>
        <div className="flex flex-col h-full gap-2 w-[25vh] shrink-0">
          <Image src={"/images/mountains-1048995_1920.jpg"} alt="" width={1920} height={1080} className="w-full flex-1 object-cover h-full"></Image>
          <div className="w-full flex-1 object-cover bg-[#E7E7E7] flex justify-center items-center h-full relative overflow-hidden">
            ...
            <span className=" text-xl h-min z-10 color-secondaryBlack">+ 5 more</span>
          </div>
        </div>
      </div>
    </div>
